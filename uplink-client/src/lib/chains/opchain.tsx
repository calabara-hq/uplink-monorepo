...
export const OpChainLogo = ({ px }) => {
    const svgStyle = { width: `${px}px`, height: `${px}px` };

    return (
        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" style={svgStyle}
            viewBox="0 0 500 500" xmlSpace="preserve">
            <style type="text/css">
                {`.st0{fill:#FF0420;} .st1{fill:#FFFFFF;}`}
            </style>
            <circle className="st0" cx="250" cy="250" r="250" />
            <path className="st1" d="M177.1,316.4c-14.9,0-27.1-3.5-36.6-10.5c-9.4-7.1-14.1-17.3-14.1-30.4c0-2.8,0.3-6.1,0.9-10.1
	...
	c-0.5-2.5-0.8-5.1-0.8-7.9C161.7,283.7,167.8,289.4,179.8,289.4z"/>
            <path className="st1" d="M259.3,314.6c-1.4,0-2.4-0.4-3.2-1.3c-0.6-1-0.8-2.1-0.6-3.4l25.9-122c0.2-1.4,0.9-2.5,2.1-3.4
