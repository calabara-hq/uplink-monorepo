...
const PageContent = async ({ submissionId }: { submissionId: string }) => {
    const submission = await fetchSingleSubmission(submissionId);
    return <ExpandedSubmission submission={submission} headerChildren={<HeaderButtons submission={submission} referrer={null} context="" />} />;
};
